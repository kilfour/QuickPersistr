...
public class PersistrTests : PersistrTest<PersistrTests>
{
    ...
    protected override void Verify(Article article)
    {
        ...
        Assert.Equal(3, article.Total().PassedExpectations());
        ...
        Assert.Equal("Course Can Clear Student", article.PassedExpectation(3).Read().Label);
    ...
    public override IPersistenceSpecification<OmittedChildDbContext> Define() =>
        Entity
            ...
            .HasMany(many => many
                ...
                .Added((course, student) => course.Students.Any(
                ...
                .Cleared(course => course.Students.Count == 0))
            .Persist();
}
