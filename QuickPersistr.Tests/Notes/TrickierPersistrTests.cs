...
public class TrickierPersistrTests : PersistrTest<TrickierPersistrTests>
{
    ...
    protected override void GetPersistr(Journalist journalist) =>
        Persistr
            ...
            .Entities(new Trickier.CoursePersistence())
    ...
    protected override void Verify(Article article)
    {
        ...
        Assert.Equal("Can Read Course.Name", article.PassedExpectation(3).Read().Label);
        Assert.Equal(1, article.PassedExpectation(3).Read().TimesPassed);
        Assert.Equal("Can Read Course.TimeRange", article.PassedExpectation(4).Read().Label);
        Assert.Equal(1, article.PassedExpectation(4).Read().TimesPassed);
        Assert.Equal("Can Read Course.DateRange", article.PassedExpectation(5).Read().Label);
        Assert.Equal(1, article.PassedExpectation(5).Read().TimesPassed);
        Assert.Equal("Can Read Course.Days", article.PassedExpectation(6).Read().Label);
        Assert.Equal(1, article.PassedExpectation(6).Read().TimesPassed);
        Assert.Equal("Can Read Course.IsDeleted", article.PassedExpectation(7).Read().Label);
        Assert.Equal(1, article.PassedExpectation(7).Read().TimesPassed);
        Assert.Equal("Can Update Course.Name", article.PassedExpectation(8).Read().Label);
        Assert.Equal(1, article.PassedExpectation(8).Read().TimesPassed);
        Assert.Equal("Can Update Course.TimeRange", article.PassedExpectation(9).Read().Label);
        Assert.Equal(1, article.PassedExpectation(9).Read().TimesPassed);
        Assert.Equal("Can Update Course.DateRange", article.PassedExpectation(10).Read().Label);
        Assert.Equal(1, article.PassedExpectation(10).Read().TimesPassed);
        Assert.Equal("Can Update Course.Days", article.PassedExpectation(11).Read().Label);
        Assert.Equal(1, article.PassedExpectation(11).Read().TimesPassed);
        Assert.Equal("Can Update Course.IsDeleted", article.PassedExpectation(12).Read().Label);
